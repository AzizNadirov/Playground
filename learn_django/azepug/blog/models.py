...
class Comment(m.Model):
    ...
    post = m.ForeignKey(Post, related_name = 'comments', null = True, blank=True, on_delete = m.CASCADE)
    vacancy = m.ForeignKey('vacancy.Vacancy', related_name='comments', null = True, blank=True, on_delete=m.CASCADE)
    ...
    likes = m.SmallIntegerField(default=0)
...
# class Reply(Comment):
#     parent = m.ForeignKey(Comment, related_name='replies', on_delete=m.CASCADE)
